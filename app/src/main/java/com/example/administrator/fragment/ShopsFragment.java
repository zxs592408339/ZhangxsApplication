...
public class ShopsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_shops_list, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mInternetListView = (ListView) getView().findViewById(R.id.internet_list_view);
        adapter = new MerchantKeyAdapter(getContext());
    ...
    public class MerchantKeyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(ShopsFragment.this).load(httpUrl).into(merchantKeyBean.internetImg);
